            ...
            <div class="modal-body">
                <form action="companies.php?id=' . $companiesData['id'] . '" method="POST" id="form-update' . $companiesData['id'] . '" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="' . $companiesData['name'] . '" placeholder="Enter Stadium Name" required />
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn" style="background-color: #a9dbcf; color: #2e4f4f" name="btn-update-stadium" id="btn-update-stadium" form="form-update' . $companiesData['id'] . '">Update Stadium</button>
                </div>
            </div>
        </div>
    </div>';
